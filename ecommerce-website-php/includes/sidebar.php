...
<img src='vendor/other_images/$manufacturer_image' width='20px' >&nbsp;
...
$p_cat_image = "<img src='vendor/other_images/$p_cat_image' width='20'> &nbsp;";
...
$cat_image = "<img src='vendor/other_images/$cat_image' width='20'>&nbsp;";
